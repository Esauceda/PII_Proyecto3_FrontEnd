...
public class frmDatos {
    ...
    //-----
    String res = "";
    String URLAlumno        = "http://192.168.42.146:8080/api/v1/Alumno";
    String URLAutor         = "http://192.168.42.146:8080/api/v1/Autor";
    String URLBibliotecario = "http://192.168.42.146:8080/api/v1/Bibliotecario";
    String URLEditorial     = "http://192.168.42.146:8080/api/v1/Editorial";
    String URLLibro         = "http://192.168.42.146:8080/api/v1/Libro";
    String URLMulta         = "http://192.168.42.146:8080/api/v1/Multa";
    String URLPrestamo      = "http://192.168.42.146:8080/api/v1/Prestamo";
    String URLReposicion    = "http://192.168.42.146:8080/api/v1/Reposicion";
    String URLSuscripcion   = "http://192.168.42.146:8080/api/v1/Suscripcion";
    String URLTutor         = "http://192.168.42.146:8080/api/v1/Tutor";
    String URLTutorias      = "http://192.168.42.146:8080/api/v1/Tutoria";
    String URLVenta         = "http://192.168.42.146:8080/api/v1/Venta";
    //-----
